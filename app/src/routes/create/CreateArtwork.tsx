  ...
  const onSubmitDetails = handleSubmit(async (values) => {
    ...
    try {
      ...
      const payload: any = {
        ...
        edition_size: values.edition_type === "limited" ? values.edition_size ?? null : null,
          ...
          <div className="card grid gap-3">
            <div className="grid md:grid-cols-3 gap-3">
              ...
              <div>
                ...
                <input className="input" type="number" step="0.00000001" {...register("list_price")} />
              </div>
            </div>
            ...
            <div className="grid md:grid-cols-3 gap-3">
              <div>
                ...
                <input className="input" placeholder="ETH / MATIC / USD" {...register("list_currency")} />
              </div>
              <div>
                <label className="block text-sm">Reserve price (auction)</label>
                <input className="input" type="number" step="0.00000001" {...register("reserve_price")} />
              </div>
              <div>
                <label className="block text-sm">Min offer</label>
                <input className="input" type="number" step="0.00000001" {...register("min_offer")} />
              </div>
            </div>
          </div>
        ...
        <div className="card space-y-3">
          ...
          {!pinning && artworkId && pinData?.tokenURI && (
            <div className="flex gap-2">
              ...
              <button className="btn" onClick={() => nav(`/art/${artworkId}`)}>Skip</button>
            </div>
          )}
        </div>
      )}
